...
struct node *create_list(int *count)
{
  ...
  printf("How many nodes you wants to insert in linked list - ");
  scanf("%d",&n);
  ...
  // Create a node if user wants to create
  while(1)
  {
...
// Function 3 : deleting the node from the end of the list 
struct node *delete_from_end(struct node *head, int *count)
{
...
void main()
{
  ...
  head = delete_from_end(head, &count);
